    ...
    <div className="flex flex-col w-full mt-5 mb-10 p-5 gap-y-10">
      <section className="flex flex-col justify-center w-[80%] mx-auto p-5 gap-y-5">
        ...
        <p className="text-sm md:text-base text-pretty">
          Sponsorship is a monthly support that you can provide financially or
          in kind (food, crates, medicines, etc.) for all our rescued people or
          for one in particular. This donation helps support our puppies during
          their adoption process by a family that, after a meticulous process,
          will be the home of this little friend for the rest of his life. If
          you want to have a pet and you cant, this is your opportunity. Go
          ahead!
        </p>
      </section>
      <section className="flex flex-col h-[300px] md:h-[500px] w-[70%] md:w-[50%] mx-auto">
        <Carousel />
      </section>
          ...
          <>
            <div className="flex justify-center items-center w-full text-center">
              <h1 className="text-xl md:text-2xl font-bold">
                There are no pets available for sponsorship.
              </h1>
            </div>
            {showToast()}
          </>
